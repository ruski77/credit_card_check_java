...
import jbehave.steps.CreditCardSteps;
 ...
 */
public class CreditCardStories  extends JUnitStory {
    ...
    public List<CandidateSteps> candidateSteps() {
        ...
        return new InstanceStepsFactory(configuration(), new CreditCardSteps()).createCandidateSteps();
    }
